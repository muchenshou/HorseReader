...
public class HorseReaderActivity extends Activity implements
		ShelfAdapter.CallBack {
		...
		listview.setOnItemClickListener(new ListView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				if (((String) adapterview.getAdapter().getItem(position))
					...
					HorseReaderActivity.this.getParent()
							.startActivityForResult(intent,
									HorseReaderActivity.READING_RESULT_CODE);
