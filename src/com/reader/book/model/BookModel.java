...
public class BookModel {
	...
	public class IteratorIml implements Element.Iterator {
		...
		public boolean hasNext() {
			return mCurrentElement.mRealFileLast.mPosition < mBook.size()-1 ;
		}
		...
		public Element next() {
			...
			mCurrentElement.mRealFileStart.setPos(cur.mRealFileLast.getPos()+1);
	...
	public Element.Iterator iterator(int elementIndex, int realfilepos) {
		...
		element.mRealFileStart.setPos(realfilepos);
